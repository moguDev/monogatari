export const Header = () => {
  return (
    <header className="fixed top-0 md:flex items-center h-20 mx-auto px-2 md:pt-7 pb-10 w-full max-w-4xl text-black select-none border-b-2 border-black backdrop-blur z-50">
